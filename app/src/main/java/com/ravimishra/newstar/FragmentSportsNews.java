...
public class FragmentSportsNews  extends Fragment {
    ...
    FrameLayout frameSportsNews;
    FragmentSportsNews.OnFragmentInteractionListener mListener;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_fragment_sports_news, container, false);

        frameSportsNews = view.findViewById(R.id.frameSportsNews);
    ...
    public void loadJSON() {
        ...
        Call<News> call;
        int page=50;
        call = apiInterface.getNews("Sports",Constants.API_KEY,page);
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof FragmentSportsNews.OnFragmentInteractionListener) {
            mListener = (FragmentSportsNews.OnFragmentInteractionListener) context;
        } else {
