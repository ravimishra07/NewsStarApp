...
public class FragmentTechNews  extends Fragment {
    Context context;
    TextView ty_error;
    ImageView iv_error;
    RecyclerView recyclerViewTopNews;
    FrameLayout frameLayoutTechnews;
    FragmentTechNews.OnFragmentInteractionListener mListener;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_fragment_tech_news, container, false);

        frameLayoutTechnews= view.findViewById(R.id.frameTechNews);
    ...
    public void loadJSON() {
        ...
        Call<News> call;
        int page=50;
        call = apiInterface.getNews("Technology",Constants.API_KEY,page);
    ...
    public FragmentTechNews() {
        // Required empty public constructor
    }
    @Override
    public void onAttach(Context context) {
        super.onAttach(context);
        if (context instanceof FragmentTechNews.OnFragmentInteractionListener) {
            mListener = (FragmentTechNews.OnFragmentInteractionListener) context;
        } else {
